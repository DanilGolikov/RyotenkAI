...
class TestMemoryManager:
    ...
    @patch("ryotenkai_pod.trainer.memory_manager.MemoryManager.cuda_available", False)
    ...
    @patch("ryotenkai_pod.trainer.memory_manager.MemoryManager.cuda_available", True)
