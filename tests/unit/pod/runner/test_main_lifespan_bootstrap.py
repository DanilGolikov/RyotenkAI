...
from ryotenkai_pod.runner.runtime.provider_registry import BootstrapConfigError
...
_spec = _ilu.spec_from_file_location("_pod_runner_conftest_for_test_lifespan", str(_conftest_path))
