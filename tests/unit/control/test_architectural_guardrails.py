...
# Path corrected 2026-05-12 (xfail audit): repo root is 3 parents up
# (worktree/tests/unit/control/test_architectural_guardrails.py → 4 levels).
ROOT = Path(__file__).parents[3]
# Post-Phase-B layout — production source lives under packages/<pkg>/src.
SRC = ROOT / "packages" / "control" / "src" / "ryotenkai_control"
...
class TestFileSizeLimits:
    ...
    Paths updated 2026-05-12 (xfail audit) to the post-Phase-B packagized
    layout (``packages/<pkg>/src/ryotenkai_<pkg>/...``).
    """
