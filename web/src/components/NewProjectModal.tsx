        ...
        <div className="p-5 space-y-4">
          <label className="block">
            ...
            <input
              ...
              placeholder="HelixQL GRPO — v1"
            />
          </label>

          <label className="block">
            <div className="text-2xs text-ink-3 mb-1">
              Project id <span className="text-ink-4">(slug)</span>
            </div>
            <input
              value={derivedId}
              onChange={(e) => {
          ...
          <label className="block">
            ...
            <input
              ...
              className="w-full rounded-md bg-surface-2 border border-line-1 px-3 py-2 text-sm font-mono focus:outline-none focus:border-brand"
              placeholder="~/.ryotenkai/projects/<id>/"
            />
            <div className="text-[0.65rem] text-ink-4 mt-1">
              Default: <span className="font-mono">~/.ryotenkai/projects/{derivedId || '<id>'}/</span>
            </div>
          </label>
