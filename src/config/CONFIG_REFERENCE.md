...
| Parameter | Type | Default | Description |
|----------|-----|--------------|----------|
| `key_path` | string | - | **REQUIRED.** Path to private SSH key for the RunPod SSH gateway |
